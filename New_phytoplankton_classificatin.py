...
# ============ TRAIN ============
checkpoint_path = "cnn_phytoplankton_best.h5"
callbacks = [
...
model.save("cnn_phytoplankton_final.h5")
print("\n💾 Final model saved as cnn_phytoplankton_final.h5")
